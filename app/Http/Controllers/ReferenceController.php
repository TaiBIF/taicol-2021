...
class ReferenceController extends Controller
{
    public function index(Request $request)
    {
        ...
        $references = $referenceQuery->paginate(20);
    ...
    {
        $reference = Reference::with(['authors', 'book'])->find($id);
        if (!$reference) {
            return response([
                'message' => 'Not Found.'
            ], 404);
    ...
    public function update(Request $request, $id)
    {
        $request->validate([
            ...
            'properties.volume' => 'required_if:type,1|integer|nullable',
            ...
            'properties.edition' => 'nullable|integer',
            'properties.chapter' => 'nullable|integer',
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($type === Reference::TYPE_JOURNAL || $type === Reference::TYPE_BOOK_ARTICLE || $type === Reference::TYPE_BOOK) {
                $newReference->saveBook($properties['book_title'], $properties['title_abbreviation'] ?? '', $editors);
            }
