<template>
    <span>
        <template v-if="taxonName.rank.key === 'hybrid-formula'">
            <taxon-name-label :indication="indication" :taxon-name="taxonName.hybridParents[0]"/>
            <author-name v-bind="{
            ...
            ×
            <taxon-name-label :indication="indication" :taxon-name="taxonName.hybridParents[1]"/>
            <author-name v-bind="{
