        ...
        <div class="tabs m-0">
            <ul>
                <li :class="{'is-active': contentType === 'taxon-name'}" v-on:click="() => contentType = 'taxon-name'">
                    <a>學名</a></li>
                <li :class="{'is-active': contentType === 'reference'}" v-on:click="() => contentType = 'reference'"><a>文獻</a>
                </li>
            </ul>
        </div>
        <div class="overflow-y-auto body">
            ...
            <div v-if="contentType === 'taxon-name'">
                    <div v-for="referenceUsages in usagesGroupByReference">
                        ...
                        <draggable v-bind="dragOptions" :list="referenceUsages"
                ...
                <draggable v-bind="dragTOptions" :list="itemGroup[2]"
                           class="item-container draggable-container"
                           data-type="taxon-name"
                           :clone="cloneTaxonNameToUsage"
                           tag="div">
                    <div v-for="item in taxonNames"
                        ...
                        <taxon-name-full-label v-else :taxon-name="item.content" :key="item.id"
            ...
            <div v-else-if="contentType === 'reference'">
                <div v-for="g in usageGroupByTaxonName" class="mb-5">
                    ...
                    <draggable v-bind="dragReferenceOptions" :list="g"
                               class="item-container draggable-container"
                               data-type="reference"
                               :clone="cloneUsageReference"
                               tag="div">
                         <div v-for="r in g">
                ...
                <draggable v-bind="dragReferenceOptions" :list="references"
                           class="item-container draggable-container"
                           data-type="reference"
