export default {
    // common
    'common.selfNotAllowed': 'Cannot be itself',

    // reference
    'reference.min': 'Required',
    'reference.not_in': 'Required',
    ...
    'reference.properties.url': 'URL format does not match',
    ...
    'taxonName.required_without': 'Required',

    // person
    'person.required': 'Required',
    'person.min': 'At least after 1100',
    'person.digits': 'Only can be AD',
    'person.integer': 'Only can be a number',
