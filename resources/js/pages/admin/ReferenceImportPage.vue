        ...
        <div class="container flex flex-col h-full">
            <div class="bg-white">
                <div class="py-3 flex items-center">
                    <p class="ml-4 font-bold text-3xl inline">{{ $t('header.adminMenu.referenceImport') }}</p>
                </div>
                ...
                <ul class="px-4 pb-2">
                    <li>1. 請依第一列表頭欄名填寫（欄位順序不拘）</li>
                    <li>2. type、publish_year 必填；type 內容：期刊文章、書籍文章、書籍</li>
                    <li>3. language 內容: 英文 、繁體中文 、日文 、簡體中文 、德文 、法文 、拉丁文 、其他</li>
                    <li>4. 期刊填 volume（卷號）、書籍填 book_volume（部冊號）</li>
                </ul>
...
export default defineComponent({
    setup() {
        ...
        const onSubmit = () => {
            ...
            axios.post('/import/references', formData, {
        ...
        onMounted(() => {
            axios.get('/import/logs/latest', { params: { type: 'reference' } })
                .then(({ data: { data } }) => {
                    if (!data) return;
